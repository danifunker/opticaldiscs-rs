...
fn stage(fixture: &str, data_name: &str, data: &[u8]) -> (tempfile::TempDir, PathBuf) {
...
fn eac_sheet_with_catalog_and_multiword_remarks_opens() {
    ...
    let (_dir, cue) = stage("eac-audio-cd.cue", "eac-audio-cd.bin", &silence(1000));
